...
export function AboutContact() {
  return (
    <section id="contacto" className="bg-neutral-950 text-white">
      <div className="mx-auto grid max-w-370 gap-8 px-5 py-14 lg:grid-cols-[1fr_1fr] lg:px-12">
        <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {contactInfo.map(([label, value]) => (
            <div key={label} className="rounded-md bg-white/5 p-5">
      ...
      <div className="mx-auto max-w-370 px-5 pb-14 lg:px-12">
