...
export function AboutHero() {
	return (
		<section className="relative overflow-hidden border-b border-neutral-200 bg-[linear-gradient(100deg,#fff_0%,#fff_52%,#f4f4f4_52%,#f7f7f7_100%)]">
			...
			<div className="relative mx-auto grid min-h-130 max-w-370 items-center gap-10 px-5 py-16 lg:grid-cols-[1fr_0.9fr] lg:px-12">
				<div>
				...
				<div className="relative min-h-90 overflow-hidden rounded-md bg-neutral-950 text-white shadow-2xl">
					...
					<div className="relative z-10 flex min-h-90 flex-col justify-end p-7">
